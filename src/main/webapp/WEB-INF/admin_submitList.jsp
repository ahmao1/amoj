                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-danger btn-xs"
                           target="mainview" href="/deletesubmit?submidId=${s.getSubmitId()}" role="button">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
    ...
    <div class="row">
        ...
        <div id="show_page_nav" class="col-md-8 text-right">
            <ul class="pagination" id="pagination">
                <li><a target="mainview" href="/adminsubmits">首页</a></li>
                <li><a target="mainview" href="/adminsubmits?page=${pageInfo.getPageNum()-1}">上一页</a></li>
                <li><a target="mainview" href="/adminsubmits?page=${pageInfo.getPageNum()+1}">下一页</a>
                <li><a target="mainview" href="/adminsubmits?page=${pageInfo.getPageSize()}">末页</a>
            </ul>
            </nav>
        </div>
    </div>
